 ...
 */
enum DefaultDoubleConverter implements Codec<Double, String> {
  ...
  @Override
  public boolean isValidSrc(Double src) {

    return true;
  }

  @Override
  public String encode(Double src) throws ValueConversionException {
