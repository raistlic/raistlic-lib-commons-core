...
public abstract class NumberTextOld {
   ...
   * no public constructors provided, -- use factory method
   ---------------------------------------------------------------------------*/
  private NumberTextOld() {

  }

  /**
   * Exports a {@code NumberTextOld} implementation instance, based on a natural
   * language argument. {@see Lang}
   *
   * @param lang
   * @return a NumberTextOld instance.
   */
  public static NumberTextOld getInstance(Lang lang) {
   ...
   * {@link NumberTextOld#getInstance(NumberTextOld.Lang)}.
   */
  public static enum Lang {

    English            (NumberTextOldEnglishCleanSpaceOnly.INSTANCE),
    EnglishWithDash    (NumberTextOldEnglish.INSTANCE),
    ChineseSimplified  (NumberTextOldChinese.SIMPLIFIED),
    ChineseTraditional (NumberTextOldChinese.TRADITIONAL),;

    private final NumberTextOld instance;

    private Lang(NumberTextOld instance) {

      this.instance = instance;
    }

    private NumberTextOld instance() {
  ...
  void checkNumber(String number) {
    ...
    if (length > limit())
      throw new UnsupportedOperationException(
              "The current " + NumberTextOld.class.getSimpleName() +
   ...
   * EnglishWithDash Implementation
   ---------------------------------------------------------------------------*/
  private static class NumberTextOldEnglish extends NumberTextOld {

    private static final NumberTextOld INSTANCE = new NumberTextOldEnglish();
   ...
   * EnglishWithDash with only Clean Space Connectors
   ---------------------------------------------------------------------------*/
  private static class NumberTextOldEnglishCleanSpaceOnly
          extends NumberTextOldEnglish {

    private static final NumberTextOld INSTANCE =
            new NumberTextOldEnglishCleanSpaceOnly();
   ...
   * ChineseSimplified Implementation
   ---------------------------------------------------------------------------*/
  private static class NumberTextOldChinese extends NumberTextOld {

    private static final NumberTextOld SIMPLIFIED =
            new NumberTextOldChinese(Type.Simplified);

    private static final NumberTextOld TRADITIONAL =
            new NumberTextOldChinese(Type.Traditional);
    ...
    private NumberTextOldChinese(Type type) {
